    ...
    <div className="mt-[70px] mb-[5rem] px-[10px]">
        ...
        <div className="lg:flex justify-center mt-[2rem]">
            <form>
                ...
                <input type="text" placeholder="First, Last Name" className="bg-[#fff] rounded-[4px] lg:w-[500px] xs:w-[100%] h-[50px] py-[17px] px-[8px] mt-[10px]" style={{ border: `1px solid #E8E8E8`, boxShadow: `0px 1px 1px 0px rgba(0, 0, 0, 0.04) inset, 0px 3px 3px -2px rgba(0, 0, 0, 0.02) inset, 0px 4px 4px -3px rgba(0, 0, 0, 0.02) inset, 0px 8px 8px -7px rgba(0, 0, 0, 0.02) inset, 0px 12px 12px -11px rgba(0, 0, 0, 0.01) inset, 0px 16px 16px -15px rgba(0, 0, 0, 0.01) inset`}} /><br/><br/>

                <label htmlFor="Name" className="text-[#000] text-[12px] font-[400] mt-[10px]">Business Address</label><br/>
                <input type="email" placeholder="Input email associated with sponsors" className="bg-[#fff] rounded-[4px] lg:w-[500px] xs:w-[100%] h-[50px] py-[17px] px-[8px] mt-[10px]" style={{ border: `1px solid #E8E8E8`, boxShadow: `0px 1px 1px 0px rgba(0, 0, 0, 0.04) inset, 0px 3px 3px -2px rgba(0, 0, 0, 0.02) inset, 0px 4px 4px -3px rgba(0, 0, 0, 0.02) inset, 0px 8px 8px -7px rgba(0, 0, 0, 0.02) inset, 0px 12px 12px -11px rgba(0, 0, 0, 0.01) inset, 0px 16px 16px -15px rgba(0, 0, 0, 0.01) inset`}} /><br/><br/>

                <label htmlFor="Name" className="text-[#000] text-[12px] font-[400] mt-[10px]">Business Name</label><br/>
                <input type="text" placeholder="Business Name" className="bg-[#fff] rounded-[4px] lg:w-[500px] xs:w-[100%] h-[50px] py-[17px] px-[8px] mt-[10px]" style={{ border: `1px solid #E8E8E8`, boxShadow: `0px 1px 1px 0px rgba(0, 0, 0, 0.04) inset, 0px 3px 3px -2px rgba(0, 0, 0, 0.02) inset, 0px 4px 4px -3px rgba(0, 0, 0, 0.02) inset, 0px 8px 8px -7px rgba(0, 0, 0, 0.02) inset, 0px 12px 12px -11px rgba(0, 0, 0, 0.01) inset, 0px 16px 16px -15px rgba(0, 0, 0, 0.01) inset`}} /><br/><br/>

                <label htmlFor="Name" className="text-[#000] text-[12px] font-[400] mt-[10px]">Sponsor Name</label><br/>
                <input type="text" placeholder="Sponsor Name" className="bg-[#fff] rounded-[4px] lg:w-[500px] xs:w-[100%] h-[50px] py-[17px] px-[8px] mt-[10px]" style={{ border: `1px solid #E8E8E8`, boxShadow: `0px 1px 1px 0px rgba(0, 0, 0, 0.04) inset, 0px 3px 3px -2px rgba(0, 0, 0, 0.02) inset, 0px 4px 4px -3px rgba(0, 0, 0, 0.02) inset, 0px 8px 8px -7px rgba(0, 0, 0, 0.02) inset, 0px 12px 12px -11px rgba(0, 0, 0, 0.01) inset, 0px 16px 16px -15px rgba(0, 0, 0, 0.01) inset`}} /><br/>
            </form>
        </div>
