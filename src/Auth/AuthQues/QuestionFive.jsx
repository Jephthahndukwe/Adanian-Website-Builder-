...
function Option({ text, isActive, onClick }) {
  return (
    <div
      className={`bg-[#fff] border-[1px] border-solid border-[#D98D2A40] hover:text-[#FB9613] rounded-[20px] flex justify-center items-center w-[150px] h-[150px] cursor-pointer`}
      onClick={onClick}
    >
      <div>
...
const QuestionFive = () => {
  ...
  return (
    <div className="mt-[119px] px-[10px]">
        <h1 className="text-[#000] text-center text-[25px] font-[500] leading-[30px]">Do you want to set your pricing plan now?</h1>
        <h3 className="text-[#000] text-center text-[18px] font-[400] leading-[16px] mt-[1.5rem]">Select all the options that apply to you</h3>
