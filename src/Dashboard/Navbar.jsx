  ...
  return (
    <div className='flex items-center gap-auto justify-between px-[24px] py-[12px]'>
        ...
        <div className='flex items-center gap-[32px]'>
            <Link to='/'><h3 className='flex items-center gap-2 text-[14px] text-[#000] font-[400]'>Titled Project <span><MdKeyboardArrowDown className='mt-[3px]' /></span></h3></Link>
            <Link to='/'><h3 className='flex items-center gap-2 text-[14px] text-[#000] font-[400]'>Help <span><MdKeyboardArrowDown className='mt-[3px]' /></span></h3> </Link> 
            <Link to='/' className='bg-[#00AABC] rounded-[100px] flex justify-center text-[14px] text-[#fff] font-[400] px-[17px] py-[10px]' style={{ boxShadow: `0px 0.5px 0.5px 0px rgba(255, 255, 255, 0.20) inset, 0px 29px 23px -16px rgba(255, 255, 255, 0.04) inset, 0px 0.5px 1px 0px rgba(0, 0, 0, 0.25)` }}>Plan Upgrade</Link> 
            <label className='rounded-[100px] flex items-center w-[324px] pr-[225] ps-[17px]' style={{ background: `rgba(10, 173, 191, 0.15)`, boxShadow: `0px 0.5px 0.5px 0px rgba(255, 255, 255, 0.20) inset, 0px 29px 23px -16px rgba(255, 255, 255, 0.04) inset, 0px 0.5px 1px 0px rgba(0, 0, 0, 0.25)` }}>
                ...
                <input type='search' placeholder='Search...' className='rounded-[100px] flex items-center w-[280px] pr-[225] ps-[8px] py-[10px] bg-transparent outline-none text-[14px] text-[#000] font-[400]' /> 
            </label>        
        </div>
