  ...
  return (
    <div className='lg:flex items-center gap-auto justify-between px-[24px] py-[12px] xs:hidden'>
        ...
        <div className='flex items-center gap-[32px]'>
            ...
            <Link to='/' className='bg-[#00AABC] rounded-[100px] flex justify-center text-[14px] text-[#fff] font-[400] px-[17px] py-[7px]' style={{ boxShadow: `0px 0.5px 0.5px 0px rgba(255, 255, 255, 0.20) inset, 0px 29px 23px -16px rgba(255, 255, 255, 0.04) inset, 0px 0.5px 1px 0px rgba(0, 0, 0, 0.25)` }}>Plan Upgrade</Link> 
