                    ...
                    <div className='lg:flex gap-[35px] items-center mt-10'>
                        <div className='bg-[#fff] py-[25px] shadow-2xl hover:shadow-lg hover:shadow-[#00AABC] px-[40px] lg:w-[450px] xs:w-[100%] lg:h-[320px] rounded-[15px]'>
                            ...
                            <p className='flex justify-center items-center mt-5'>
                                <Link to='/' className='lg:text-[16px] xs:text-[13px] text-center font-[500] leading-[24px] text-[#fff] bg-[#00AABC] hover:bg-[#116dff] py-[9px] px-[30px] lg:w-[55%] xs:w-[65%] rounded-[100px]'>Get Started</Link>
                            </p>
                        </div>
                        <div className='bg-[#fff] shadow-2xl py-[25px] hover:shadow-lg hover:shadow-[#00AABC] px-[40px] lg:w-[450px] xs:w-[100%] lg:h-[320px] rounded-[15px] lg:mt-0 xs:mt-[2rem]'>
                            ...
                            <p className='flex justify-center items-center mt-5'>
                                <Link to='/website/templates' className='lg:text-[16px] xs:text-[13px] text-center font-[500] leading-[24px] text-[#fff] bg-[#00AABC] hover:bg-[#116dff] py-[9px] px-[30px] lg:w-[55%] xs:w-[70%] rounded-[100px]'>Pick a Template</Link>
                            </p>
                        </div>
                    </div>
                </div>
