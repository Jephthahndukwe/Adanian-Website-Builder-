    ...
    <div>
        <div className="lg:flex justify-bwtween items-center lg:gap-[108px] xs:gap-[90px] py-[49px] lg:px-[90px] xs:px-[5px]">
            ...
            <div>
                ...
                <h3 className="mt-[32px]"><Link to='/login' className="text-[#000] text-center text-[17px] font-[500] bg-[#fff] rounded-[100px] py-[13px] px-[24px] underline flex justify-center items-center gap-5 w-[183px] hover:bg-[#FB9613] hover:text-[#fff]">Get Started <FaArrowRight /> </Link></h3>
            </div>
        </div>
    </div>
  )
