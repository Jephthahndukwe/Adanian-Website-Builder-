...
const Template = () => {
  return (
    <div className="lg:px-0 xs:px-[20px]">
        ...
        <h3 className="mt-[36px] flex justify-center items-center"><Link to='/login' className="text-[#000] text-[20px] font-[400] leading-[28px] bg-[#fff] rounded-[100px] py-[10px] px-[30px] text-center hover:bg-[#FB9613] hover:text-[#fff] no-underline">Get Started</Link></h3>
