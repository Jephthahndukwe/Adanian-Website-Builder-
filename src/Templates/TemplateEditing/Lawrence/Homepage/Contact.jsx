 ...
 const onSelectFile = (event) => {
     ...
     img.onload = function () {
         if (this.width > 3000 || this.height > 2000) {
             setErrorMessage('Image dimensions exceed 3000x2000 pixels. Please select a smaller image.');
             setTimeout(() => {
                 setErrorMessage('');
             }, 10000); // Hide the error message after 10 seconds
             return;
    ...
    <div>
        ...
        <div className='bg-[#faf8f1] pt-[2rem]'>
            ...
            {errorMessage && <p style={{ color: 'red' }}>{errorMessage}</p>}
                {selectedImage ? (
                    <div style={{ backgroundImage: `linear-gradient(to bottom, rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url(${selectedImage})`,  backgroundPosition: `center`, backgroundSize: `cover`, backgroundRepeat: `no-repeat` }} className='w-[100%] h-[150vh] bg-fixed mt-[5rem]' onClick={handleImageClick}>
                    ...
                    <div style={{ backgroundImage: `linear-gradient(to bottom, rgba(0,0,0,0.2), rgba(0,0,0,0.2)), url(${restro6})`, backgroundPosition: `center`, backgroundSize: `cover`, backgroundRepeat: `no-repeat` }} className='w-[100%] h-[150vh] bg-fixed mt-[5rem]' onClick={() => document.getElementById('fileInput').click()}>
                        <div className='lg:flex justify-center items-center h-[150vh]'>
                            <form className='text-[#fff] lg:pt-0 xs:pt-[5rem]'>
                                <h1 className='font-Namdhinggo text-[50px] lg:w-[60%] text-center lg:ms-[14rem] hover:border-[1px] hover:border-solid hover:border-[#000] hover:py-[10px] hover:px-[10px]' onClick={handleElementClick}>We Welcome Your Feedback</h1>
                            <div className='lg:ms-[7rem] mt-[4rem] lg:px-0 xs:px-[20px]'>
