        ...
        <div className='bg-[#faf8f1] pt-[2rem]'>
            ...
            <div className='lg:flex justify-center items-center gap-[4rem] lg:px-[100px] mt-[4rem]'>
                <div>
                    ...
                    <h3 className='mt-[3rem] flex justify-center items-center lg:ms-[-7rem]'><Link to='/LawrenceEditMenu' className='text-[#fff] text-[16px] font-[400] no-underline hover:text-[#fff] hover:bg-[#493f30] bg-[#7c6c50] py-[15px] px-[50px]'>View Menu</Link></h3>
                </div>
                ...
                <div className='flex justify-center items-center h-[100vh] text-content'>
                    <div className='bg-[#faf8f1] py-[70px] lg:px-[30px] px-[20px] lg:w-[50%] xs:w-[90%] flex justify-center items-center'>
                        <div>
                            ...
                            <h3 className='mt-[3rem] flex justify-center items-center'><Link to='/LawrenceEditAbout' className='text-[#fff] text-[16px] hover:text-[#fff] font-[400] no-underline bg-[#7c6c50] hover:bg-[#493f30] py-[15px] px-[50px]'>About Lawrence</Link></h3>
                        </div>
                    </div>
                </div>
            </div>
