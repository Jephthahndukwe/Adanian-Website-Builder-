...
const Footer = ({ handleElementClick }) => {
  return (
    <div className='bg-dark foot pt-[1rem] mt-[4rem]'>
        <div className="container">
            ...
            <p className='f-style text-light text-uppercase text-center pb-4' onClick={handleElementClick}>© 2035 Soair Africa. Powered and secured by <Link to='/' className='text-[18px] text-[#fff] font-[100] font-Namdhinggo hover:text-[#fff]'>Adanian Labs</Link></p>
        </div>
    </div>
  )
}
