  ...
  const handleClick = () => {
    ...
    return (
        <div>
          ...
          <div className='flex justify-center items-center h-[70vh] px-[10px]'>
            <div>
                ...
                <div className='flex justify-center items-center mt-[1.5rem]'>
                    <button to='/SoairEditHome' className='bg-[#00AABC] lg:w-[35%] xs:w-[50%] rounded-[50px] py-[10px] px-[20px] text-[#fff] text-[16px] font-[500] no-underline hover:text-[#fff] text-center flex justify-center items-center' onClick={handleClick}>Create a New Site</button>
                </div>
          ...
          {loading && <LoadingContext redirectTo="/SoairEditHome" />}
        </div>
    )
}
