    ...
    <div className='lg:flex justify-between items-center lg:px-[20px] py-[5px]'>
        ...
        <div>
            <ul className='flex items-center lg:gap-[1.5rem] xs:gap-[3rem] mt-2'>
                ...
                <li><Link to=''  className='no-underline text-[#00AABC] border-[#00AABC] border-[1px] border-solid py-[7px] px-[20px] rounded-[50px] text-[14px] hover:bg-[#00AABC] hover:text-[#fff]'>Preview</Link></li>
