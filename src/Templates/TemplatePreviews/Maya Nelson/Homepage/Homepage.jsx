        ...
        <div className='lg:mt-[-3rem]'>
            ...
            <div className='lg:flex items-center'>
                <div className='bg-[#E6DACE] lg:w-[80vw] xs:w-[100vw] lg:h-[150vh] xs:h-[120vh] lg:mt-[5rem] xs:mt-[27rem] lg:flex gap-[4rem] items-center'>
                    <div className='bg-[#f4ece6] lg:shadow-xl xs:shadow-2xl lg:w-[30vw] xs:w-[90%] absolute lg:ms-[14rem] xs:ms-[1.5rem] lg:mt-0 xs:mt-[-19rem]'>
                            <div className='flex items-center justify-center py-[50px] px-[20px]'>
                                <div>
                                    <img src={data && data.data.images.selectedImage1 ? data.data.images.selectedImage1 : portfo1} className='rounded-[100px] lg:ms-4 xs:ms-12'/>
                                    <h2 className='text-[28px] text-center font-Urbanist font-[900] mt-4' style={{ color: data && data.data && data.data.texts && data.data.texts.heading1 ? data.data.texts.heading1.color : "#000" }}>{data && data.data && data.data.texts && data.data.texts.heading1 ? data.data.texts.heading1.text : 'Maya Nelson'}</h2>
                                    <div className='w-[30%] h-[2px] bg-blue-600 mt-4 lg:ms-[5rem] xs:ms-[6.3rem]'/>
                                    <h3 className='lg:block xs:hidden text-[20px] font-[300] font-Urbanist mt-[2rem] tracking-[5px]' style={{ color: data && data.data && data.data.texts && data.data.texts.heading2 ? data.data.texts.heading2.color : "#000" }}>{data && data.data && data.data.texts && data.data.texts.heading2 ? data.data.texts.heading2.text : 'PROJECT MANAGER'}</h3>
                ...
                <div className='lg:mt-[7.5rem] xs:mt-[-43rem] lg:ms-[8rem] xs:ms-[2rem]'>
                    <h1 className='lg:text-[100px] xs:text-[60px] font-Urbanist font-[900] text-start' style={{ color: data && data.data && data.data.texts && data.data.texts.heading3 ? data.data.texts.heading3.color : "#000" }}>{data && data.data && data.data.texts && data.data.texts.heading3 ? data.data.texts.heading3.text : 'Hello'}</h1>
                    <h3 className='lg:text-[25px] xs:text-[20px] font-Urbanist font-[600] text-start mt-2' style={{ color: data && data.data && data.data.texts && data.data.texts.heading4 ? data.data.texts.heading4.color : "#000" }}>{data && data.data && data.data.texts && data.data.texts.heading4 ? data.data.texts.heading4.text : 'Heres who I am & what I do'}</h3>
                    ...
                    <p className='lg:text-[16px] xs:text-[18px] font-Urbanist font-[400] leading-[26px] tracking-wider lg:w-[50%] xs:w-[95%] mt-[3rem]' style={{ color: data && data.data && data.data.texts && data.data.texts.heading5 ? data.data.texts.heading5.color : "#000" }}>{data && data.data && data.data.texts && data.data.texts.heading5 ? data.data.texts.heading5.text : 'I’m a paragraph. Click here to add your own text and edit me. It’s easy. Just click “Edit Text” or double click me to add your own content and make changes to the font.'}</p>
                    <p className='lg:text-[16px] xs:text-[18px] font-Urbanist font-[400] leading-[26px] lg:w-[50%] xs:w-[95%] mt-[2rem]' style={{ color: data && data.data && data.data.texts && data.data.texts.heading6 ? data.data.texts.heading6.color : "#000" }}>{data && data.data && data.data.texts && data.data.texts.heading6 ? data.data.texts.heading6.text : 'I’m a great place for you to tell a story and let your users know a little more about you.'}</p>
                </div>
            </div>
