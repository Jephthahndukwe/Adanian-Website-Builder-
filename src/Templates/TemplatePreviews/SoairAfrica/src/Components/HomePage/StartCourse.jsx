    ...
    <div>
        ...
        <div className='row course-images'>
            <div className='col-lg-4 col-md-8 col-sm-8 mt-5'>
                ...
                <Link to='/SoairCourse' className='f-style link-btn text-dark text-center'>Read More</Link>
                </div>
            </div>
            <div className='col-lg-4 col-md-8 col-sm-8 mt-5'>
            ...
            <Link to='/SoairCourse'><button className='btn-generally mt-5 text-center'>More Courses</button></Link>
        </div>
        </center>
