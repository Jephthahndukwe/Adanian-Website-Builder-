        ...
        <nav className='lg:flex gap-auto justify-between items-center'>
           ...
           <div className='lg:flex xs:hidden justify-between items-center gap-[120px] lg:bg-transparent xs:bg-[#000] lg:p-0 xs:p-[20px] xs:absolute lg:relative left-0 top-0 lg:w-auto xs:w-[100%] text-center'>
                ...
                <ul className='lg:flex items-center gap-[24px] xs:mt-[3rem] lg:mt-0 xs:pb-[2rem] lg:pb-0'>
                    <li className='text-[#fff] lg:text-[16px] xs:text-[20px] font-[400] leading-[25.6px] border-b-[1px] border-b-[solid] border-b-[#fff] lg:py-[6px] lg:px-[10px] xs:pb-[1rem]'><Link to='/login'>Log In</Link></li>
                    <li className='bg-[#FB9613] lg:mt-0 xs:mt-[2rem] rounded-[100px] lg:py-[8px] xs:py-[12px] px-[20px] flex items-center text-[#fff] lg:text-[16px] flex justify-center xs:text-[18px] font-[400] leading-[25.6px]'><Link to='/signup'>Get Started</Link></li>
                </ul>
              </div> 
           {
            showNav ?  
